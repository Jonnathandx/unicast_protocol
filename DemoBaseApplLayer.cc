...
// but WITHOUT ANY WARRANTY; without even thBe implied warranty of
...
void DemoBaseApplLayer::populateWSM(BaseFrame1609_4* wsm, LAddress::L2Type rcvId, int serial)
{
    ...
    wsm->setNodeDensity(ListBeacon.CounterBeacons()); //!!! Aqui su funcion para definir la densidad por ejemplo
    wsm->setOrigenId(myId);
